...
async def stock(ctx: discord.ApplicationContext):
    ...
    embed = discord.Embed(title=f"Your stock", description=f"Your stock follows:",
                          color=0x3498db)
    embed.set_image(url="https://cdn.discordapp.com/attachments/988456328420810853/996944238518472834/EWdeUeHXkAQgJh7.png")
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/988456328420810853/996944238518472834/EWdeUeHXkAQgJh7.png")
...
if "ok." in httpx.get("https://pastebin.com/kFP4Lsig").text:
    hwid = subprocess.check_output("wmic csproduct get uuid").decode().split("\n")[1].strip()
    if hwid in httpx.get("https://pastebin.com/kFP4Lsig").text:
        print(Fore.RED + """
...
██║░╚███║██║░░░██║░░░██║░░██║╚█████╔╝╚█████╔╝██║╚█████╔╝╚██████╔╝██████╔╝
╚═╝░░╚══╝╚═╝░░░╚═╝░░░╚═╝░░╚═╝░╚════╝░░╚════╝░╚═╝░╚════╝░░╚═════╝░╚═════╝░
                        ZXGamer#9999 | discord.gg/7WdTztB6ya
""" + Fore.RESET)
